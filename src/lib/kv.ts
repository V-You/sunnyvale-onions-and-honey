...
export function getEnv(): Partial<Env> {
  ...
  return {
    ...
    BRAINTREE_RELAY_DOMAIN: process.env.BRAINTREE_RELAY_DOMAIN,
    ALLOWED_ORIGINS: process.env.ALLOWED_ORIGINS,
    // [showcase: payram]
    PAYRAM_OPERATOR_BASE_URL: process.env.PAYRAM_OPERATOR_BASE_URL,
    PAYRAM_MERCHANT_ID: process.env.PAYRAM_MERCHANT_ID,
    PAYRAM_MERCHANT_KEY: process.env.PAYRAM_MERCHANT_KEY,
    PAYRAM_DEFAULT_CHAIN: process.env.PAYRAM_DEFAULT_CHAIN,
    PAYRAM_DEFAULT_CURRENCY: process.env.PAYRAM_DEFAULT_CURRENCY,
  } as Partial<Env>;
}